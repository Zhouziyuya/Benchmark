...
_C.OUTPUT = "/sda1/zhouziyu/ssl/downstream_checkpoints/shenzhenCXR"
...
_C.DATA.DATA_PATH = "/sda1/zhouziyu/ssl/dataset/shenzhenCXR/images/images/"
# dataset name
_C.DATA.DATASET = 'shenzhenCXR'
# dataset lists and labels
_C.DATA.TRAIN_LIST = '/home/zhouziyu/warmup/sslpretrain/BenchmarkTransformers/dataset/ShenzenCXR_train_data.txt'
_C.DATA.VAL_LIST = '/home/zhouziyu/warmup/sslpretrain/BenchmarkTransformers/dataset/ShenzenCXR_valid_data.txt'
_C.DATA.TEST_LIST = '/home/zhouziyu/warmup/sslpretrain/BenchmarkTransformers/dataset/ShenzenCXR_test_data.txt'
...
# _C.TRAIN.BASE_LR = 1e-3 # linear probing: 12N
...
def update_config(config, args):
    ...
    if config.PRETRAIN_MODE == 'popar_pec':
        config.MODEL.PRETRAINED = '/data/zhouziyu/ssl/CheXpert/checkpoints/sslpretrained_model/pec+popar/output/last.pth'
...
def get_config_shenzhenCXR(args):
