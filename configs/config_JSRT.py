...
_C.OUTPUT = '/sda1/zhouziyu/ssl/downstream_checkpoints/JSRT/'
_C.PRETRAIN_MODE = 'popar_pec'
_C.SEG_PART = 'all'
_C.RATIO = '100' # 参与训练的训练集比例
...
# image size before tencrop
_C.DATA.CROP_SIZE = 256
# Path to dataset, could be overwritten by command line argument
_C.DATA.DATA_PATH = '/sda1/zhouziyu/ssl/dataset/JSRT/All247images/images_png/'
_C.DATA.MASK_HEART = '/sda1/zhouziyu/ssl/dataset/JSRT/All247images/masks/heart_png'
_C.DATA.MASK_CLA1 = '/sda1/zhouziyu/ssl/dataset/JSRT/All247images/masks/left_clavicle_png'
_C.DATA.MASK_CLA2 = '/sda1/zhouziyu/ssl/dataset/JSRT/All247images/masks/right_clavicle_png'
_C.DATA.MASK_LUNG1 = '/sda1/zhouziyu/ssl/dataset/JSRT/All247images/masks/left_lung_png'
_C.DATA.MASK_LUNG2 = '/sda1/zhouziyu/ssl/dataset/JSRT/All247images/masks/right_lung_png'
# dataset name
_C.DATA.DATASET = 'NIHchest'
# dataset lists and labels
_C.DATA.TRAIN_LIST = '/sda1/zhouziyu/ssl/dataset/JSRT/All247images/jsrt_split/train.txt'
_C.DATA.VAL_LIST = '/sda1/zhouziyu/ssl/dataset/JSRT/All247images/jsrt_split/val.txt'
_C.DATA.TEST_LIST = '/sda1/zhouziyu/ssl/dataset/JSRT/All247images/jsrt_split/test.txt'
...
def update_config(config, args):
    ...
    if _check_args('seg_part'):
        config.SEG_PART = args.seg_part
    ...
    if config.DATA.IMG_SIZE == 448:
        if config.LINEAR_PROB:
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+'_linearprob_448_'+config.SEG_PART+'_ratio'+config.RATIO+config.DATA.FOLD)
        else:
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+'_448_'+config.SEG_PART+'_ratio'+config.RATIO+config.DATA.FOLD)
    else:
        config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+config.SEG_PART+config.DATA.FOLD)
