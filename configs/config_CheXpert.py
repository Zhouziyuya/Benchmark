...
_C.OUTPUT = '/data/zhouziyu/ssl/CheXpert/checkpoints/'
...
_C.DATA.DATA_PATH = '/data/zhouziyu/ssl/CheXpert/'
# dataset name
_C.DATA.DATASET = 'CheXpert'
# dataset lists and labels
_C.DATA.TRAIN_LIST = "/data/zhouziyu/ssl/CheXpert/CheXpert-v1.0/train.csv"
_C.DATA.VAL_LIST = "/data/zhouziyu/ssl/CheXpert/CheXpert_valtest/val_labels.csv"
_C.DATA.TEST_LIST = "/data/zhouziyu/ssl/CheXpert/CheXpert_valtest/test_labels.csv"
...
_C.TRAIN.LR_SCHEDULER.DECAY_EPOCHS = 30 # cosine LR里没用到
...
def update_config(config, args):
    ...
    if config.PRETRAIN_MODE == 'popar_pec':
        ...
        config.MODEL.PRETRAINED = '/data/zhouziyu/ssl/CheXpert/checkpoints/sslpretrained_model/popar/last.pth'
