...
_C.OUTPUT = '/sda1/zhouziyu/ssl/downstream_checkpoints/SIIM/'
...
_C.DATA.IMAGE = '/sda1/zhouziyu/ssl/dataset/SIIM-ACR_Pneumothorax_segmentation/image_all_dcm'
_C.DATA.MASK = '/sda1/zhouziyu/ssl/dataset/SIIM-ACR_Pneumothorax_segmentation/mask_all_png'

# # dataset name
_C.DATA.DATASET = 'NIHchest'
# dataset lists and labels
_C.DATA.TRAIN_LIST = '/data/zhouziyu/home3/zhouziyu/warmup/sslpretrain/Swin-Transformer/data/data_split/SIIM/train.txt'
_C.DATA.VAL_LIST = '/data/zhouziyu/home3/zhouziyu/warmup/sslpretrain/Swin-Transformer/data/data_split/SIIM/val.txt'
_C.DATA.TEST_LIST = '/data/zhouziyu/home3/zhouziyu/warmup/sslpretrain/Swin-Transformer/data/data_split/SIIM/test.txt'
...
def update_config(config, args):
    ...
    if config.DATA.IMG_SIZE == 448:
        if config.LINEAR_PROB:
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+'_linearprob_448_ratio'+config.RATIO+config.DATA.FOLD)
        else:
            config.OUTPUT = os.path.join(config.OUTPUT, config.PRETRAIN_MODE+'_448_ratio'+config.RATIO+config.DATA.FOLD)
    else:
